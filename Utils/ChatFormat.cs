...
///
/// Коды цветов берутся из ChatColors самого CounterStrikeSharp — своя таблица управляющих
/// байтов ровно так и расходится с движком после очередного обновления игры.
public static partial class ChatFormat
{
    ...
    /// съедается, и строка выходит белой. Поэтому CounterStrikeSharp в собственном ChatMenu
    /// печатает ровно так — с пробелом перед первым цветом.
    ///
