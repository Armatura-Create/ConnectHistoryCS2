...
| наигранное время | `css_playtime` (игрок) | `sw_playtime` (игрок) | `!playtime` / `ch_playtime` (игрок), `ch_playtime <steamid64>` (консоль) |
| последние заходы | `css_lastseen` (игрок) | `sw_lastseen` (игрок) | `!lastseen` / `ch_lastseen` (игрок), `ch_lastseen <steamid64>` (консоль) |

В нативной цели команды игрока отвечают в чат, как и везде: работают и `!playtime`,
и `/playtime`, а проглатываются только свои команды — остальной чат другие плагины
видят как обычно. С консоли сервера те же команды принимают SteamID64 и отвечают
в консоль: так спрашивают про игрока, которого сейчас нет на сервере.
