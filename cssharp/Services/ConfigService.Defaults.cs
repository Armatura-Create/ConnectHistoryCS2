...
public sealed partial class ConfigService
{
    ...
    private static void WriteReadme(string directory)
    {
        var text = new StringBuilder()
            ...
            .AppendLine("  CountSpectatorTime     — считать ли время в наблюдателях наигранным.")
            .AppendLine("                           false — из наигранного вычитается время вне игры.")
            .AppendLine("                           Само время всегда пишется в spectator_seconds.")
