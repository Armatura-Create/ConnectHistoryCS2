...
public sealed partial class ConfigService
{
    ...
    private static void WriteReadme(string directory)
    {
        var text = new StringBuilder()
            ...
            .AppendLine("  Messages.json          - texts for the sw_playtime / sw_lastseen commands")
            ...
            .AppendLine()
            .AppendLine("COMMANDS")
            .AppendLine("  sw_ch_status                - status: database link, queue, last error")
            .AppendLine("  sw_ch_reload                - reload the configuration")
            .AppendLine("  sw_playtime                 - own playtime")
            .AppendLine("  sw_lastseen                 - own recent sessions")
            .AppendLine()
